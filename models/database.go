...
func ConnectDB() (*mongo.Client, error) {
	mongoClient, err := mongo.Connect(context.Background(), options.Client().ApplyURI("mongodb+srv://Admin:EnterpriseWeb@enterpriseweb.zfnzhcx.mongodb.net/?retryWrites=true&w=majority"))
	if err != nil {
		return nil, err
	}
